 ...
 *
 * @checksum - 7eaab73d7dd8c426fdd6dde095d97decab39db12367af7579528b92d9fed8cbe
 * @variables - radius=rounded,accentColor=violet,colorTemperature=gray,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'togglebuttons__input': {
    ...
    'group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-violet-500':
      true,
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-violet-600':
      true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-violet-600':
      true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-violet-600':
      true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-violet-600':
      true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-violet-600':
      true,
    ...
    'group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-violet-500':
      true,
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-violet-600':
      true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-violet-600':
      true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-violet-600':
      true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-violet-600':
      true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-violet-600':
      true,
  },
  'transferlist__outer': {
    'group': true,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-violet-600':
      true,
    ...
    'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-violet-600':
      true,
  },
